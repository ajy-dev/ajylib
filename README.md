...
<details>
<summary>echo_server - IOCP 코어 기능을 검증하고 동시성 오류를 잡다</summary>
...
그리고 실제로 몇몇 코어 로직의 문제를 이 예제를 통해서 찾아내고 디버깅하였습니다.
...
에코 서버의 TPS가 0으로 감소하여 회복되지 않거나, 서버의 종료 단계에서 스레드가 join되지 못하고 멈추는 일이 나타났습니다.
