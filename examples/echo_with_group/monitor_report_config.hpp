 ...
 * Path: ajylib/examples/echo_with_group/monitor_report_config.hpp
 * Description:
...
#ifndef ECHO_WITH_GROUP_MONITOR_REPORT_CONFIG_HPP
#define ECHO_WITH_GROUP_MONITOR_REPORT_CONFIG_HPP
