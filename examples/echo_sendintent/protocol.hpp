/**
 * File: protocol.hpp
 * Path: ajylib/examples/echo_sendintent/protocol.hpp
 * Description:
 *	Shared packet types for the echo_sendintent example
 * Note:
...
#ifndef ECHO_SENDINTENT_PROTOCOL_HPP
#define ECHO_SENDINTENT_PROTOCOL_HPP
