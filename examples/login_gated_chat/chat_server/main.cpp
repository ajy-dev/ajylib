/**
 * File: main.cpp
 * Path: ajylib/examples/login_gated_chat/chat_server/main.cpp
 * Description:
 *	Entry point for the login_gated_chat example's chat server. Drives the
 *	server through an interactive management console; type 'help' for
 *	available commands, 'exit' to quit.
 * Note:
...
#include <login_gated_chat/chat_server/monitor_reporter.hpp>
