/**
 * File: protocol.hpp
 * Path: ajylib/examples/echo_baseline_sw/protocol.hpp
 * Description:
 *	Shared packet types for the echo_baseline_sw example
 * Note:
...
#ifndef ECHO_BASELINE_SW_PROTOCOL_HPP
#define ECHO_BASELINE_SW_PROTOCOL_HPP
