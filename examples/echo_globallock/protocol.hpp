/**
 * File: protocol.hpp
 * Path: ajylib/examples/echo_globallock/protocol.hpp
 * Description:
 *	Shared packet types for the echo_globallock example
 * Note:
...
#ifndef ECHO_GLOBALLOCK_PROTOCOL_HPP
#define ECHO_GLOBALLOCK_PROTOCOL_HPP
