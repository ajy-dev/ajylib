 ...
 * Path: ajylib/examples/echo_globallock/echo_server_config.hpp
 * Description:
 *	Configuration constants for the echo_globallock example
 * Author: ajy-dev
 * Created: 2026-08-10
 * Updated: Never
 * Version: 0.1.0
...
#ifndef ECHO_GLOBALLOCK_SERVER_CONFIG_HPP
#define ECHO_GLOBALLOCK_SERVER_CONFIG_HPP
...
namespace EchoServerConfig
{
	...
	// --- Send workers ---
	// The locked section hands finished packets here, so no WSASend is
	// issued while the global lock is held.
