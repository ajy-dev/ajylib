...
bool MonitorReporter::send_login(void) noexcept
{
	...
	packet << type << MonitorReportConfig::GAME_SERVER_NO;
...
void MonitorReporter::report_metrics(void) noexcept
{
	...
	const Metric metrics[] = {
		{MonitorReportConfig::MonitorDataType::GAME_SERVER_RUN, 1},
		{MonitorReportConfig::MonitorDataType::GAME_SERVER_CPU, this->probe_value("process_cpu")},
		{MonitorReportConfig::MonitorDataType::GAME_SERVER_MEM, this->probe_value("process_mem_mb")},
		{MonitorReportConfig::MonitorDataType::GAME_SESSION, static_cast<std::int32_t>(this->server.get_session_count())},
		{MonitorReportConfig::MonitorDataType::GAME_AUTH_PLAYER, static_cast<std::int32_t>(this->server.get_auth_session_count())},
		{MonitorReportConfig::MonitorDataType::GAME_GAME_PLAYER, static_cast<std::int32_t>(this->server.get_echo_session_count())},
		{MonitorReportConfig::MonitorDataType::GAME_ACCEPT_TPS, static_cast<std::int32_t>(this->server.get_accept_tps())},
		{MonitorReportConfig::MonitorDataType::GAME_PACKET_RECV_TPS, static_cast<std::int32_t>(this->server.get_recv_message_tps())},
		{MonitorReportConfig::MonitorDataType::GAME_PACKET_SEND_TPS, static_cast<std::int32_t>(this->server.get_send_message_tps())},
		{MonitorReportConfig::MonitorDataType::GAME_DB_WRITE_TPS, 0},
		{MonitorReportConfig::MonitorDataType::GAME_DB_WRITE_MSG, 0},
		{MonitorReportConfig::MonitorDataType::GAME_AUTH_THREAD_FPS, static_cast<std::int32_t>(this->server.get_auth_frame_tps())},
		{MonitorReportConfig::MonitorDataType::GAME_GAME_THREAD_FPS, static_cast<std::int32_t>(this->server.get_echo_frame_tps())},
		{MonitorReportConfig::MonitorDataType::GAME_PACKET_POOL, static_cast<std::int32_t>(this->server.get_packet_pool_in_use())},
	};
