/**
 * File: echo_sendworker_server.hpp
 * Path: ajylib/examples/echo_sendworker/echo_sendworker_server.hpp
 * Description:
...
#ifndef ECHO_SENDWORKER_SERVER_HPP
#define ECHO_SENDWORKER_SERVER_HPP
...
class EchoSendWorkerServer : public ajy::network::windows::iocp::NetServer
{
public:
	explicit EchoSendWorkerServer(std::string_view logger_name) noexcept;
	~EchoSendWorkerServer(void) noexcept override;

	EchoSendWorkerServer(const EchoSendWorkerServer &other) = delete;
	EchoSendWorkerServer &operator=(const EchoSendWorkerServer &other) = delete;
	EchoSendWorkerServer(EchoSendWorkerServer &&other) = delete;
	EchoSendWorkerServer &operator=(EchoSendWorkerServer &&other) = delete;
