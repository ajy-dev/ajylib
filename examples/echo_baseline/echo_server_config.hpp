 ...
 * Path: ajylib/examples/echo_baseline/echo_server_config.hpp
 * Description:
 *	Configuration constants for the echo_baseline example
 * Author: ajy-dev
 * Created: 2026-08-10
 * Updated: Never
 * Version: 0.1.0
...
#ifndef ECHO_BASELINE_SERVER_CONFIG_HPP
#define ECHO_BASELINE_SERVER_CONFIG_HPP
