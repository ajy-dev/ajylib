/**
 * File: protocol.hpp
 * Path: ajylib/examples/echo_baseline/protocol.hpp
 * Description:
 *	Shared packet types for the echo_baseline example
 * Note:
...
#ifndef ECHO_BASELINE_PROTOCOL_HPP
#define ECHO_BASELINE_PROTOCOL_HPP
